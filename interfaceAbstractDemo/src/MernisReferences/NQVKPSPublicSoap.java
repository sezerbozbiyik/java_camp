...
public class NQVKPSPublicSoap
{
    ...
    public NQVKPSPublicSoap(){}

    public NQVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public NQVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        NQVExtendedSoapSerializationEnvelope envelope= new NQVExtendedSoapSerializationEnvelope(NQVExtendedSoapSerializationEnvelope.VER11);
